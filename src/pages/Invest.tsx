...
const ALL_SYMBOLS = [
  ...
  "BAJAJFINSV.NS", "TECHM.NS", "HCLTECH.NS", "ADANIENT.NS", "ADANIPORTS.NS",
  "POWERGRID.NS", "NTPC.NS", "ONGC.NS", "JSWSTEEL.NS", "TATASTEEL.NS",
  "COALINDIA.NS", "DRREDDY.NS", "CIPLA.NS", "APOLLOHOSP.NS", "EICHERMOT.NS",
  "DIVISLAB.NS", "BRITANNIA.NS", "ASIANPAINT.NS", "HEROMOTOCO.NS", "INDUSINDBK.NS",
  "GRASIM.NS", "M&M.NS", "BPCL.NS", "TATACONSUM.NS", "HINDALCO.NS",
